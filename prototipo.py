...
while True:
    ...
    print('''\033[0;34m
            OPERAÇÕES MATEMÁTICAS
    Escolha abaixo a ferramenta desejada... 23, 24, 25, 26, 38, 
    [ 01 ] - Soma                                                               [ 21 ] - Calcular potenciação
    [ 02 ] - Média                                                              [ 22 ] - Calcular temperaturas
    [ 03 ] - Tabuada                                                            [ 23 ] - Contar data
    [ 04 ] - Calculadora                                                        [ 24 ] - Conversor de Bases Numéricas
    [ 05 ] - Raíz Quadrada                                                      [ 25 ] - Calcular dias desde nascimento
    [ 06 ] - Dobro, Triplo & Raíz Quadrada                                      [ 26 ] - Calcular idade
    ...
    [ 18 ] - Calcular área                                                      [ 38 ] - Data e hora atual
...
[3] converter para HEXADECIMAL''')
        ...
        while True:
            ...
            print('\nNesse ano você completa \033[0;33m{}\033[m ano(s).\n'.format(idade))
            # Aqui vai o "Deseja continuar?"
            resp = " "
            while resp not in "10":
                resp = str(input("\033[0;34mDeseja continuar [1 - SIM / 0 - NÃO]? \033[m")).strip().upper()[0]
