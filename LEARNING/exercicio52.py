# 52. Uma fruteira está vendendo frutas com a seguinte tabela de preços:
...
# Fonte: https://github.com/karenyov/exerciciosPythonBrasil/blob/master/2_EstruturaDeDecisao/27.py
